...
import com.git.notificationcompose.app.Important_Notification_Id

fun createImportantNotification(context: Context){
    val notification = NotificationCompat.Builder(context, Important_Notification_Id)
